...
const Header: React.FC<Props> = ({ onOpenSettings }) => {
  return (
    <header className="bg-white dark:bg-gray-950 px-6 pt-3 pb-3 flex items-center justify-end sticky top-0 z-30 border-b border-transparent dark:border-gray-900">
      <button
